...
distr_sigma = ot.TruncatedDistribution(
    ot.LogNormal(3.31, 0.294), 3 / 0.6, ot.TruncatedDistribution.LOWER
)
distr_h = ot.LogNormal(8.48, 0.063)
distr_rho_p = ot.LogNormal(-0.592, 0.219)
distr_m_l = ot.TruncatedDistribution(
    ot.Normal(1.18, 0.377), 0, ot.TruncatedDistribution.LOWER
)
distr_m_d = ot.Normal(0.19, 0.047)
distr_S_t = ot.TruncatedDistribution(
    ot.Normal(0.049, 0.011), 0, ot.TruncatedDistribution.LOWER
)
distr_U = 6.9 * ot.LogNormal(1.0174, 0.5569)
distr_tan_phi = ot.TruncatedDistribution(
    ot.Normal(0.38, 0.186), 0, ot.TruncatedDistribution.LOWER
)
distr_P = ot.TruncatedDistribution(
    ot.LogNormal(-2.19, 0.64), 1, ot.TruncatedDistribution.UPPER
)
...
np.savez(
    "data/Fire_spread_boxplots_gm.npz",
    theo_values=reference_values["ref"],
